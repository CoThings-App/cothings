defmodule ColivingWeb.PageController do
  ...
  def privacy(conn, _params) do
    ...
    render(conn, "privacy.html", log_usage_enabled: log_usage_enabled, page_title: "Privacy", url: url, server_source_code_url: server_source_code_url, ios_source_code_url: ios_source_code_url)
  end
